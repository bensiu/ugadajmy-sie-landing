...
export const page: DetailPageProps = {
  ...
  seo: {
    title: 'Coaching Kariery Szczecin | Rozwój Zawodowy',
  ...
  listOfBenefits: {
    title: 'Co zyskasz dzięki coachingowi kariery?',
    items: [
      'Jasność w&nbsp;podejmowaniu decyzji zawodowych',
      'Odkrycie swoich mocnych stron i&nbsp;unikalnych kompetencji',
      'Skuteczniejsze osiąganie celów kariery',
