...
export const page: DetailPageProps = {
  ...
  whenToUse: {
    ...
    situations: [
      ...
      'Konflikty w&nbsp;zespole obniżają produktywność i&nbsp;morale',
      'Stoisz przed ważnymi negocjacjami biznesowymi',
      'Chcesz zbudować silniejszą kulturę organizacyjną',
      'Planujesz ekspansję i&nbsp;potrzebujesz jasnej strategii'
    ]
  },
  howProcess: {
    title: 'Jak wygląda proces coachingu biznesowego?',
    steps: [
      { title: 'Diagnoza biznesu', description: 'Analizujemy obecną sytuację firmy, wyzwania i&nbsp;możliwości rozwoju' },
      { title: 'Cele strategiczne', description: 'Definiujemy konkretne cele biznesowe i&nbsp;wskaźniki sukcesu' },
      { title: 'Plan działania', description: 'Tworzymy strategię z&nbsp;konkretnymi krokami i&nbsp;harmonogramem' },
      { title: 'Realizacja i&nbsp;monitoring', description: 'Wdrażasz plan, a ja wspieram Cię w&nbsp;pokonywaniu przeszkód' }
    ]
  },
  listOfBenefits: {
    title: 'Co zyskasz dzięki coachingowi biznesowemu?',
    items: [
      'Jasna wizja i&nbsp;strategia rozwoju biznesu',
  ...
  frequentlyAskedQuestions: {
    ...
    //     value: 'dla-jakiej-wielkosci-firm-jest-coaching-biznesowy'
    //   },
    //   {
    ...
    //     value: 'czy-coaching-obejmuje-doradztwo'
    //   },
    //   {
    ...
    //     value: 'jak-czesto-odbywaja-sie-sesje-coaching-biznesowego'
    //   },
    //   {
    ...
    //     value: 'czy-coaching-moze-pomoc-w-rozwiazaniu-konfliktow'
    //   },
    //   {
    ...
    //     value: 'ile-kosztuje-coaching-biznesowy'
    //   }
    // ]
  },
  callToAction: {
