...
export const page: DetailPageProps = {
  ...
  howProcess: {
    title: 'Jak przebiegają mediacje okołorozwodowe?',
    steps: [
  ...
  listOfBenefits: {
    title: 'Korzyści z&nbsp;mediacji okołorozwodowej',
    items: [
      'Rozwód za porozumieniem stron – szybszy i&nbsp;tańszy',
      'Dzieci nie są wciągane w&nbsp;konflikt rodziców',
      'Sami decydujecie o&nbsp;warunkach, nie sędzia',
      'Budujecie fundament dobrej współpracy rodzicielskiej',
      'Unikacie traumy wieloletniego procesu sądowego'
    ]
  },
