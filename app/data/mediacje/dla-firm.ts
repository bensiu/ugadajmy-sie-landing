...
export const page: DetailPageProps = {
  ...
  whenToUse: {
    ...
    situations: [
      ...
      'Firma przechodzi sukcesję i&nbsp;pojawiają się spory rodzinne'
    ]
  },
  howProcess: {
    title: 'Jak przebiega mediacja firmowa?',
    steps: [
      { title: 'Diagnoza', description: 'Poznaję sytuację i&nbsp;identyfikuję strony konfliktu' },
      { title: 'Rozmowy wstępne', description: 'Spotykam się osobno z&nbsp;każdą stroną' },
      { title: 'Sesje mediacyjne', description: 'Prowadzę wspólne rozmowy i&nbsp;szukamy rozwiązań' },
      { title: 'Porozumienie', description: 'Spisujemy ustalenia i&nbsp;wdrażamy rozwiązania' }
    ]
  },
  listOfBenefits: {
    ...
    items: [
      ...
      'Zachowanie talentów – nie tracisz wartościowych ludzi',
      'Trwałe rozwiązanie – strony same je wypracowują',
      'Poprawa kultury organizacyjnej – ludzie uczą się rozmawiać'
    ]
  },
