...
export const page: DetailPageProps = {
  ...
  whenToUse: {
    title: 'Dla kogo są szkolenia z&nbsp;komunikacji?',
    situations: [
  ...
  howProcess: {
    title: 'Jak wygląda szkolenie z&nbsp;komunikacji?',
    steps: [
      { title: 'Diagnoza stylu komunikacji', description: 'Poznanie własnych wzorców i&nbsp;nawyków komunikacyjnych' },
      { title: 'Poznanie technik', description: 'Nauka konkretnych narzędzi i&nbsp;metod skutecznej komunikacji' },
      { title: 'Praktyka i&nbsp;ćwiczenia', description: 'Symulacje rozmów, analiza przypadków, praca w&nbsp;parach' },
      { title: 'Plan wdrożenia', description: 'Opracowanie strategii zastosowania nowych umiejętności' }
    ]
  },
  listOfBenefits: {
    ...
    items: [
      ...
      'Techniki asertywnego komunikowania granic',
