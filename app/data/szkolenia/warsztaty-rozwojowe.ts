...
export const page: DetailPageProps = {
  ...
  seo: {
    title: 'Warsztaty Rozwojowe Szczecin | Rozwój Osobisty',
  ...
  whenToUse: {
    ...
    situations: [
      ...
      'Każdy, kto chce lepiej radzić sobie ze stresem',
      'Osoby szukające inspiracji i&nbsp;wsparcia grupy'
    ]
  },
  howProcess: {
    title: 'Jak wygląda warsztaty?',
    steps: [
      { title: 'Wprowadzenie', description: 'Poznanie uczestników, budowanie bezpiecznej przestrzeni grupowej' },
      { title: 'Eksploracja tematu', description: 'Przekazanie wiedzy, refleksja nad własnymi doświadczeniami' },
      { title: 'Praca praktyczna', description: 'Ćwiczenia indywidualne i&nbsp;w parach, praca z&nbsp;ciałem i&nbsp;emocjami' },
      { title: 'Integracja', description: 'Podsumowanie wniosków, planowanie wdrożenia zmian' }
    ]
  },
  listOfBenefits: {
