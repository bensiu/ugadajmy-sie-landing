...
export const page: DetailPageProps = {
  ...
  whenToUse: {
    title: 'Dla kogo są szkolenia mediacyjne?',
    situations: [
      'Osoby planujące karierę mediatora',
      'Prawnicy chcący poszerzyć warsztat o&nbsp;mediację',
      'Specjaliści HR rozwiązujący konflikty w&nbsp;organizacjach',
      'Menedżerowie mediujący między pracownikami',
      'Terapeuci i&nbsp;coachowie pracujący z&nbsp;parami i&nbsp;rodzinami',
      'Pracownicy socjalni i&nbsp;pedagodzy',
      'Osoby pracujące w&nbsp;obszarze rozwiązywania sporów'
    ]
  },
  howProcess: {
    title: 'Jak wygląda szkolenie mediacyjne?',
    steps: [
      { title: 'Podstawy mediacji', description: 'Poznanie zasad, etapów i&nbsp;technik prowadzenia mediacji' },
      { title: 'Symulacje praktyczne', description: 'Prowadzenie sesji mediacyjnych w&nbsp;bezpiecznym środowisku' },
      { title: 'Superwizja', description: 'Analiza prowadzonych mediacji i&nbsp;feedback od trenera' },
      { title: 'Certyfikacja', description: 'Egzamin praktyczny i&nbsp;wydanie certyfikatu ukończenia' }
    ]
  },
  listOfBenefits: {
