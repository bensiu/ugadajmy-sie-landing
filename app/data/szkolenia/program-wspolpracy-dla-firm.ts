...
export const page: DetailPageProps = {
  ...
  whenToUse: {
    title: 'Dla jakich firm jest program współpracy?',
    situations: [
      'Firmy chcące systematycznie rozwijać kompetencje miękkie zespołu',
      'Organizacje z&nbsp;częstymi konfliktami wymagające stałego wsparcia mediatora',
  ...
  howProcess: {
    ...
    steps: [
      { title: 'Audyt organizacji', description: 'Poznanie firmy, diagnoza potrzeb i&nbsp;wyzwań komunikacyjnych' },
      { title: 'Projektowanie programu', description: 'Opracowanie rocznego planu działań i&nbsp;form współpracy' },
      { title: 'Realizacja działań', description: 'Prowadzenie szkoleń, mediacji, coachingu wg ustalonego harmonogramu' },
      { title: 'Ewaluacja i&nbsp;optymalizacja', description: 'Regularna ocena efektów i&nbsp;dostosowywanie programu' }
    ]
  },
  listOfBenefits: {
